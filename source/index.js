...
export default class GesturePassword extends React.Component {
  ...
  render() {
    ...
    let textColor = this.props.status === 'wrong' ? this.props.wrongTextColor : this.props.rightTextColor;
    return (
      <View style={[styles.frame, this.props.style, {flex: 1}]}>
        <View style={styles.message}>
          <Text style={[styles.msgText, this.props.textStyle, {color: textColor}]}>
...
GesturePassword.propTypes = {
  ...
  wrongTextColor: PropTypes.string,
